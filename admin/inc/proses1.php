 ...
 $fileError = $_FILES['gambar']['error'];  
	if($_POST['sts']=="input"){
		 if($fileSize > 0 || $fileError == 0){  
			...
			$con->InsertDataAnggota($_POST['name'], $_POST['tempat'], $_POST['tanggal'], $_POST['alamat'], $_POST['telepon'], $_POST['email'], $_POST['kdpos'], $_POST['Agama'], $_POST['sex'], $fileName, $_POST['username'], md5($_POST['password']),"Admin",$_POST['idKop']);
		...
		$status="Input Data";
		 ...
		 if($fileSize > 0 || $fileError == 0){  
			...
			$data=$con->getDataAnggota($_POST['id']);
...
?>
			...
			<script type="text/javascript">
				window.location.assign("index.php?p=tAdmin")
			</script>
