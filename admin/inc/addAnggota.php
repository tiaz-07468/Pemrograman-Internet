<?php 
	...
	if($_GET['p']==null ||$_GET['p']=="addAnggota" ){
            ...
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                  <hr />
		    <div class="col-md-6">
		    	<form action="index.php?p=insertProses" method="post" enctype="multipart/form-data">
			      	<!-- Data Detail Anggota -->		    		
